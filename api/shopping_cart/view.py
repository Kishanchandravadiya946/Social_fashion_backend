...
shopping_cart_item=Blueprint('shopping_cart_item',__name__,url_prefix='/shopping_cart_item')

@shopping_cart_item.route('/create',methods=['POST'])
@jwt_required()
def shopping_cart_item_create():
    return ShoppingCartResource.post()

@shopping_cart_item.route('/list',methods=['GET'])
@jwt_required()
def shopping_cart_item_create():
...
@jwt_required()
def shopping_cart_item_create(item_id):
    return ShoppingCartResource.put(item_id)

@shopping_cart_item.route('/delete/<int:item_id>',methods=['DELETE'])
@jwt_required()
def shopping_cart_item_create(item_id):
